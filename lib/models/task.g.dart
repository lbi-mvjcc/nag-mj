...
const TaskSchema = CollectionSchema(
	...
	properties: {
		...
		type: IsarType.string,
		enumMap: _TaskrecurrenceTypeEnumValueMap,
		),
...
void _taskSerialize(
	...
	writer.writeLong(offsets[6], object.recurrenceInterval);
	writer.writeString(offsets[7], object.recurrenceType.name);
...
Task _taskDeserialize(
	...
	object.recurrenceInterval = reader.readLong(offsets[6]);
	object.recurrenceType =
		_TaskrecurrenceTypeValueEnumMap[reader.readStringOrNull(offsets[7])] ??
			RecurrenceType.none;
	object.reminderDateTime = reader.readDateTimeOrNull(offsets[8]);
...
P _taskDeserializeProp<P>(
	...
	switch (propertyId) {
		...
		case 6:
				return (reader.readLong(offset)) as P;
		case 7:
				return (_TaskrecurrenceTypeValueEnumMap[
...
const _TaskrecurrenceTypeEnumValueMap = {
	r'none': r'none',
	r'daily': r'daily',
	r'weekly': r'weekly',
	r'monthly': r'monthly',
};
const _TaskrecurrenceTypeValueEnumMap = {
	r'none': RecurrenceType.none,
...
extension TaskQueryWhere on QueryBuilder<Task, Task, QWhereClause> {
	...
	QueryBuilder<Task, Task, QAfterWhereClause> idGreaterThan(Id id, {bool include = false}) {
		return QueryBuilder.apply(this, (query) {
			return query.addWhereClause(
	...
	QueryBuilder<Task, Task, QAfterWhereClause> idLessThan(Id id, {bool include = false}) {
		return QueryBuilder.apply(this, (query) {
			return query.addWhereClause(
	...
	QueryBuilder<Task, Task, QAfterWhereClause> titleStartsWith(String TitlePrefix) {
		return QueryBuilder.apply(this, (query) {
			return query.addWhereClause(IndexWhereClause.between(
				indexName: r'title',
				lower: [TitlePrefix],
...
extension TaskQueryFilter on QueryBuilder<Task, Task, QFilterCondition> {
	QueryBuilder<Task, Task, QAfterFilterCondition> createdAtEqualTo(DateTime value) {
		return QueryBuilder.apply(this, (query) {
	...
	QueryBuilder<Task, Task, QAfterFilterCondition> createdAtGreaterThan(DateTime value, {
		bool include = false,
	}) {
		return QueryBuilder.apply(this, (query) {
	...
	QueryBuilder<Task, Task, QAfterFilterCondition> notificationIdEqualTo(
			int value) {
		return QueryBuilder.apply(this, (query) {
			return query.addFilterCondition(FilterCondition.equalTo(
	...
	QueryBuilder<Task, Task, QAfterFilterCondition> notificationIdGreaterThan(
		int value, {
		bool include = false,
	}) {
		return QueryBuilder.apply(this, (query) {
	...
	QueryBuilder<Task, Task, QAfterFilterCondition> notificationIdLessThan(
		int value, {
		bool include = false,
	}) {
		return QueryBuilder.apply(this, (query) {
	...
	QueryBuilder<Task, Task, QAfterFilterCondition> notificationIdBetween(
		int lower,
		int upper, {
		bool includeLower = true,
		bool includeUpper = true,
	...
	QueryBuilder<Task, Task, QAfterFilterCondition> recurrenceTypeEqualTo(
	...
	QueryBuilder<Task, Task, QAfterFilterCondition> recurrenceTypeGreaterThan(
		RecurrenceType value, {
		bool include = false,
		bool caseSensitive = true,
	}) {
	...
	QueryBuilder<Task, Task, QAfterFilterCondition> recurrenceTypeLessThan(
		RecurrenceType value, {
		bool include = false,
		bool caseSensitive = true,
	}) {
	...
	QueryBuilder<Task, Task, QAfterFilterCondition> recurrenceTypeBetween(
	...
	QueryBuilder<Task, Task, QAfterFilterCondition> recurrenceTypeStartsWith(
		String value, {
		bool caseSensitive = true,
	}) {
		return QueryBuilder.apply(this, (query) {
	...
	QueryBuilder<Task, Task, QAfterFilterCondition> recurrenceTypeEndsWith(
		String value, {
		bool caseSensitive = true,
	}) {
		return QueryBuilder.apply(this, (query) {
	...
	QueryBuilder<Task, Task, QAfterFilterCondition> recurrenceTypeContains(
			String value,
			{bool caseSensitive = true}) {
		return QueryBuilder.apply(this, (query) {
			return query.addFilterCondition(FilterCondition.contains(
	...
	QueryBuilder<Task, Task, QAfterFilterCondition> recurrenceTypeMatches(
			String pattern,
			{bool caseSensitive = true}) {
		return QueryBuilder.apply(this, (query) {
			return query.addFilterCondition(FilterCondition.matches(
	...
	QueryBuilder<Task, Task, QAfterFilterCondition> recurrenceTypeIsEmpty() {
		return QueryBuilder.apply(this, (query) {
			return query.addFilterCondition(FilterCondition.equalTo(
				property: r'recurrenceType',
				value: '',
	...
	QueryBuilder<Task, Task, QAfterFilterCondition> recurrenceTypeIsNotEmpty() {
		return QueryBuilder.apply(this, (query) {
			return query.addFilterCondition(FilterCondition.greaterThan(
				property: r'recurrenceType',
				value: '',
...
extension TaskQuerySortBy on QueryBuilder<Task, Task, QSortBy> {
	...
	QueryBuilder<Task, Task, QAfterSortBy> sortByNotificationId() {
		return QueryBuilder.apply(this, (query) {
			return query.addSortBy(r'notificationId', Sort.asc);
		});
	}

	QueryBuilder<Task, Task, QAfterSortBy> sortByNotificationIdDesc() {
		return QueryBuilder.apply(this, (query) {
	...
	QueryBuilder<Task, Task, QAfterSortBy> sortByRecurrenceType() {
		return QueryBuilder.apply(this, (query) {
			return query.addSortBy(r'recurrenceType', Sort.asc);
		});
	}

	QueryBuilder<Task, Task, QAfterSortBy> sortByRecurrenceTypeDesc() {
		return QueryBuilder.apply(this, (query) {
...
extension TaskQuerySortThenBy on QueryBuilder<Task, Task, QSortThenBy> {
	...
	QueryBuilder<Task, Task, QAfterSortBy> thenByNotificationId() {
		return QueryBuilder.apply(this, (query) {
			return query.addSortBy(r'notificationId', Sort.asc);
		});
	}

	QueryBuilder<Task, Task, QAfterSortBy> thenByNotificationIdDesc() {
		return QueryBuilder.apply(this, (query) {
			return query.addSortBy(r'notificationId', Sort.desc);
		});
	}
	...
	QueryBuilder<Task, Task, QAfterSortBy> thenByRecurrenceType() {
		return QueryBuilder.apply(this, (query) {
			return query.addSortBy(r'recurrenceType', Sort.asc);
		});
	}

	QueryBuilder<Task, Task, QAfterSortBy> thenByRecurrenceTypeDesc() {
		return QueryBuilder.apply(this, (query) {
			return query.addSortBy(r'recurrenceType', Sort.desc);
		});
	}
...
extension TaskQueryWhereDistinct on QueryBuilder<Task, Task, QDistinct> {
	...
	QueryBuilder<Task, Task, QDistinct> distinctByNotificationId() {
		return QueryBuilder.apply(this, (query) {
	...
	QueryBuilder<Task, Task, QDistinct> distinctByRecurrenceType(
			{bool caseSensitive = true}) {
		return QueryBuilder.apply(this, (query) {
...
extension TaskQueryProperty on QueryBuilder<Task, Task, QQueryProperty> {
	...
	QueryBuilder<Task, int, QQueryOperations> notificationIdProperty() {
		return QueryBuilder.apply(this, (query) {
	...
	QueryBuilder<Task, RecurrenceType, QQueryOperations>
